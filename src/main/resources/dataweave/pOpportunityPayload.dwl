...
[
	{
		...
		"RFP_Received_Date__c": if (regex::nullChars(opp_details.received_date) != null) opp_details.received_date as Date {format:"MM/dd/yyyy"} as String {format:"yyyy/MM/dd"} as Date  {format:"yyyy/MM/dd"} else null,
		"RFP_Due_Date__c": if (regex::nullChars(opp_details.due_date) != null) opp_details.due_date as Date {format:"MM/dd/yyyy"} as String {format:"yyyy/MM/dd"} as Date  {format:"yyyy/MM/dd"} else null,
		...
		"Proposed_Broker_External_Commission__c": (regex::nullChars(broker_opp_details.commission) default "") as String,
