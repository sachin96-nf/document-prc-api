...
var name=regex::nullChars(broker_opp_details.name default broker_details.agency_name default "") splitBy " "
---
[
	{
		...
		"Email": regex::emailReplace(broker_opp_details.email replace  " " with "_"),
