...
var name=regex::escapeSingleQuote(regex::nullChars(broker_details.agency_name) default regex::nullChars(broker_opp_details.name) default vars.broker_name_email.agency default " ")
